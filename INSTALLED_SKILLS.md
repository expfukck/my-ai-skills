...
### add-skill
**用途：** 使用 npx add-skill 安装、更新并管理 skills 与来源仓库。
**触发关键词：** 安装 skill、更新 skill、从 GitHub 安装、npx add-skill、浏览 skills
...
**用途：** Vercel 的 React/Next.js 性能优化实践与模式指南。
**触发关键词：** React、Next.js、性能优化、数据获取、bundle 优化
